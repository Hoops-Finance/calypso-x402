 ...
 */
export function addressBookFromSuiteJson(json) {
    return {
        network: "testnet",
 ...
 */
export function loadAddressBookFromFile(filePath) {
 ...
 */
export function addressBookFromEnv(env = process.env) {
 ...
 */
export function getAddressBook(network) {
    switch (network) {
        case "testnet": {
